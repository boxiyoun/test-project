import socketserver # 소켓 프로그래밍에 필요한 API 제공
...
if __name__ == "__main__":
    ...
    try:
        ...
        #클라이언트의 접속 요청 수신 대기
        #접속 요청 수락 후 BaseReqeustHandler의 handle 메소드 호출
...
asdfasefhzdxkjgbfvzsldfjzesf;h
